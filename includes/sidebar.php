            ...
            <ul class="list">
                <li class="sidebar-user-panel active">
                    <div class="user-panel">
                        <div class=" image">
                            <img src="<?php echo "assets/img/".$admin_profile_img ?>" class="user-img-style" alt="User Image" />
                        </div>
                    </div>
                    <div class="profile-usertitle">
                        <div class="sidebar-userpic-name"><?php echo $admin_full_name; ?></div>
                        <div class="profile-usertitle-job "><?php echo $admin_role; ?> </div>
                    </div>
                </li>
                <li class="active">
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li>
                                    <a href="all-permanent-staff.php">Permanent Staff</a>
                                </li>
                                <li>
                                    <a href="all-temporary-staff.php">Temporary Staff</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li>
                                    <a href="add-permanent-staff.php">Add Permanent Staff</a>
                                </li>
                                <li>
                                    <a href="add-temporary-staff.php">Add Temporary Staff</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        ...
                        <li>
                            <a href="edit-department.php">Edit Departments</a>
                        </li>
                    </ul>
                </li>
                <!-- <li>
    ...
    <aside id="rightsidebar" class="right-sidebar">
        <ul class="nav nav-tabs tab-nav-right" role="tablist">
            <li role="presentation">
                <a href="#skins" data-bs-toggle="tab" class="active">COLOR SETTINGS</a>
            </li>
            <!-- <li role="presentation">
